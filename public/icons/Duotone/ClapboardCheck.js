...
const SvgClapboardCheck = ({ title, titleId, ...props }) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <g mask="url(#Clapboard_Check_svg__a)" strokeWidth={2}>
      <path
        ...
        stroke="#555770"
      />
      <path d="m9 13 2.692 2.5 4.308-4" stroke="currentColor" />
    </g>
  </svg>
);

export default SvgClapboardCheck;
