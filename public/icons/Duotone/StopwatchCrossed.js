...
const SvgStopwatchCrossed = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <g clipPath="url(#Stopwatch_Crossed_svg__a)">
      ...
      <g mask="url(#Stopwatch_Crossed_svg__b)" strokeWidth={2}>
        <path d="M12 6.5V13m9-9-2.156 2.156M10 2h4" stroke="currentColor" />
        <path d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" stroke="#555770" />
      </g>
