...
const SvgAddFolder = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <path
      d="M15 10v6m3-3h-6M10.293 6.707l.293.293H20a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h4.586l1.707 1.707Z"
      stroke="#555770"
      strokeWidth={2}
    />
    <mask
      id="Add_Folder_svg__a"
      style={{
        maskType: "alpha",
      }}
