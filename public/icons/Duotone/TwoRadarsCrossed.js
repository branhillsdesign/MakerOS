...
const SvgTwoRadarsCrossed = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <g mask="url(#Two_Radars_Crossed_svg__a)">
      ...
      <g mask="url(#Two_Radars_Crossed_svg__b)" strokeWidth={2}>
        <circle
          cx={20}
          cy={20}
          r={9}
      ...
      <g mask="url(#Two_Radars_Crossed_svg__c)" strokeWidth={2}>
        <circle cx={4} cy={4} r={9} stroke="#555770" />
        <circle cx={4} cy={4} r={5} stroke="currentColor" />
        <circle cx={4} cy={4} r={1} stroke="#555770" />
      </g>
