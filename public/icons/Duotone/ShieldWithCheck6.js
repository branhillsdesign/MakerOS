...
const SvgShieldwithCheck6 = ({ title, titleId, ...props }) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <mask id="Shield_with_Check_6_svg__a" fill="#fff">
    ...
    <path
      ...
      fill="#555770"
      mask="url(#Shield_with_Check_6_svg__a)"
    />
    <path d="m8 12.5 3 2.5 5.5-5" stroke="currentColor" strokeWidth={2} />
  </svg>
);

export default SvgShieldwithCheck6;
