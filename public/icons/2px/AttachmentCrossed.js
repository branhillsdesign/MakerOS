...
const SvgAttachmentCrossed = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <g mask="url(#Attachment_Crossed_svg__a)" stroke="#555770" strokeWidth={2}>
      <path d="m3.524 4.942 15.5 15.5M5 8h12.5a4.5 4.5 0 1 1 0 9H5a3 3 0 1 1 0-6h11.5a1.5 1.5 0 0 1 0 3H5" />
    </g>
  </svg>
);
