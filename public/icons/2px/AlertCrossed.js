...
const SvgAlertCrossed = ({ title, titleId, ...props }) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <g mask="url(#Alert_Crossed_svg__a)">
      <path d="m3.524 4.942 15.5 15.5" stroke="#555770" strokeWidth={2} />
      <mask id="Alert_Crossed_svg__b" fill="#fff">
...
export default SvgAlertCrossed;
