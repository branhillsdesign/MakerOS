...
const SvgNotepadCheck = ({ title, titleId, ...props }) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <path
      d="M10.268 2.6h.346l.173-.3a1.4 1.4 0 0 1 2.426 0l.173.3H15.4v2.8H8.6V2.6h1.668ZM16 10l-5.333 5L8 12.5"
      stroke="#555770"
      strokeWidth={1.2}
    />
  </svg>
...
export default SvgNotepadCheck;
