...
const SvgShieldwithX01 = ({ title, titleId, ...props }) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <mask id="Shield_with_X_01_svg__a" fill="#fff">
    ...
    <path
      ...
      fill="#555770"
      mask="url(#Shield_with_X_01_svg__a)"
    />
    <path d="m9 15 6-6M9 9l6 6" stroke="#555770" strokeWidth={1.2} />
  </svg>
);

export default SvgShieldwithX01;
