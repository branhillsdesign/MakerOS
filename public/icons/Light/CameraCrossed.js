...
const SvgCameraCrossed = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <g clipPath="url(#Camera_Crossed_svg__a)">
      <mask
        id="Camera_Crossed_svg__b"
        style={{
          maskType: "alpha",
        }}
      ...
      <g mask="url(#Camera_Crossed_svg__b)">
        <path d="m2.173 3 17.5 17.5" stroke="#555770" strokeWidth={1.2} />
        <path
    ...
    <defs>
      <clipPath id="Camera_Crossed_svg__a">
